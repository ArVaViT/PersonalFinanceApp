...
const GoalDetails = () => {
    ...
    useEffect(() => {
        const fetchGoal = async () => {
            try {
                ...
                const res = await axios.get(`https://my-personal-finance-app-1e2eb0485e32.herokuapp.com/api/goals/${id}`, config);
    ...
    const onSubmit = async e => {
        ...
        try {
            ...
            await axios.put(`https://my-personal-finance-app-1e2eb0485e32.herokuapp.com/api/goals/${id}`, formData, config);
